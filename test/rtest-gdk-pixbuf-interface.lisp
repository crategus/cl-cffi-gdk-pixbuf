...
(test pixbuf-formats
  (is (every #'pointerp (gdk-pixbuf:pixbuf-formats)))
  #-windows
...
(test pixbuf-format-infos.1
  (let ((format (gdk-pixbuf:pixbuf-file-info (sys-path "test/ducky.png"))))
    ...
    (is-true (gdk-pixbuf:pixbuf-format-is-save-option-supported format "compression"))
...
(test pixbuf-format-infos.2
  (let ((format (gdk-pixbuf:pixbuf-file-info (sys-path "test/floppybuddy.gif"))))
    ...
    (is-false (gdk-pixbuf:pixbuf-format-is-save-option-supported format "compression"))
